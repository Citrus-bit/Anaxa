...
class TestGetCheckpointer:
    def test_returns_in_memory_saver_when_not_configured(self):
        ...
        # Bypass the lazy loader as well as the provider lookup.  Otherwise
        # ``ensure_config_loaded`` can find the repository's real config.yaml
        # through ``deerflow.config.app_config.get_app_config`` before this
        # patched provider lookup runs, turning the fallback case into a
        # legitimate SQLite configuration.
        with (
