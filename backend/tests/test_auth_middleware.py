...
def test_auth_disabled_is_ignored_in_medrix_production_env(monkeypatch):
    """The documented MEDRIX_FLOW_ENV marker must disable auth bypass."""
    monkeypatch.setenv("DEER_FLOW_AUTH_DISABLED", "1")
...
def test_auth_disabled_startup_warning_suppressed_in_medrix_production_env(monkeypatch, caplog):
    from app.gateway.auth_disabled import warn_if_auth_disabled_enabled
