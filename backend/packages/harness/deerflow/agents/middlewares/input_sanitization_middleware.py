...
_BLOCKED_TAG_NAMES: frozenset[str] = frozenset(
    {
        ...
        "output_format",
        "working_directory",
        # Specialist built-in subagents may emit these authority blocks in
        # their system prompts. Keep them in the shared denylist so a user or
        # remote tool result cannot forge specialist guidance on any runtime
        # path (the lead and all subagents share this sanitizer).
        "design_expertise",
        "quality_standards",
        "resource_library",
