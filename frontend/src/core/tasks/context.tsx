...
/**
 * Return whether a partial task update changes any field on the existing task.
 *
 * This small predicate is part of the historical Anaxa API and remains useful
 * to integrations that apply task patches outside React. The provider itself
 * uses the richer `computeNextSubtask` transition so cumulative steps/usage
