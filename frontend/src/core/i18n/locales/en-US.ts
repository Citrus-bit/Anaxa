...
export const enUS: Translations = {
  ...
  common: {
    ...
    backendUnavailableHint:
      "Try clicking Retry. If the problem persists, restart the server with: make stop && make dev",
    retryNow: "Retry",
    refresh: "Refresh",
    latest: "Latest",
  },
  ...
  conversation: {
    ...
    modelProviderOverloaded:
      "The model provider is temporarily overloaded or unavailable. Try again later or switch models.",
  },
  ...
  threadDetails: {
    ...
    activeRunPolling: "The run is still active; details are polling for new events.",
    streaming: "Streaming",
    noFilesTitle: "No output files",
    noFilesDescription:
      "Files generated by the agent, such as PDFs, tables, images, and code, appear here.",
    noLogsTitle: "No run logs",
    noLogsDescription:
      "Tool calls, subtasks, file outputs, and status events are recorded as the run progresses.",
    unrecorded: "Unrecorded",
    slowSteps: "Slowest steps",
    noSlowSteps: "No measurable slow steps yet.",
  ...
  settings: {
    ...
    features: {
      title: "Features",
      description:
        "Read-only inventory of configured agents, MCP tools, and skills.",
      readonlyHint:
        "This view audits the current capability surface. Frontend edits are disabled.",
      agentsTitle: "Agents",
      toolsTitle: "Tools",
      skillsTitle: "Skills",
  ...
  setup: {
    title: "Setup",
    description:
      "Configure chat models, image generation providers, tool API keys, and academic retrieval keys.",
    modelsTitle: "Model Configuration",
    modelsDescription:
      "Add and manage chat model providers. Each model needs a provider, model name, and API key.",
    toolKeysTitle: "Tool / Academic API Keys",
    toolKeysDescription:
      "Configure keys for web search, web fetch, and academic retrieval enhancement.",
    imageGenerationTitle: "Image Generation",
    imageGenerationDescription:
      "Choose the active image provider and configure Google AI Studio or an OpenAI-compatible image API.",
    ...
    imageGenerationMissingFields:
      "Missing required fields for the active image provider:",
    saveAll: "Save Configuration",
    saveSuccess: "Configuration saved successfully.",
    noChanges: "No unsaved changes.",
    loadingSlow: "Loading is taking longer than expected",
    loadingSlowHint:
      "The backend service may still be starting. You can wait or try again.",
    retry: "Retry",
    noModelsConfigured: "No models configured",
    noModelsConfiguredHint:
      "Configure at least one chat model in settings to start chatting.",
