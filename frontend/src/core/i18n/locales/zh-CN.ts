...
export const zhCN: Translations = {
  ...
  common: {
    ...
    backendUnavailableHint:
      "请点击重试。如问题持续，请在终端执行：make stop && make dev",
    retryNow: "重试",
    refresh: "刷新",
    latest: "最新",
  },
  ...
  runStatus: {
    running: "运行中",
    reconnecting: "后台任务仍在运行，正在恢复流式连接...",
    error: "任务已出错",
    interrupted: "任务已中断",
  ...
  threadDetails: {
    ...
    title: "详情",
    description: "智能体工作流、工具调用、产出文件与运行日志",
    flow: "流程",
    files: "产出",
    stats: "统计",
    logs: "日志",
    ...
    noWorkflowDescription:
      "当前运行还没有记录到可还原的智能体规划、决策或工具步骤；产出文件请在“产出”页查看。",
    noWorkflowEventsTitle: "暂无工作流事件",
    noWorkflowEventsDescription: "当前运行已注册，但还没有记录到可展示的事件。",
    noSummary: "暂无摘要。",
    currentRun: "当前 Run",
    wholeThread: "整个对话",
    ...
    activeRunPolling: "后台任务仍在运行，详情面板正在轮询新的事件。",
    streaming: "流式输出中",
    noFilesTitle: "暂无产出文件",
    noFilesDescription: "智能体生成 PDF、表格、图片或代码文件后，会显示在这里。",
    noLogsTitle: "暂无运行日志",
    noLogsDescription: "运行开始后，工具调用、子任务、文件产出和状态事件会逐步记录。",
    unrecorded: "未记录",
    slowSteps: "慢步骤来源",
    noSlowSteps: "暂无可统计的慢步骤。",
  ...
  setup: {
    title: "配置",
    description:
      "配置聊天模型、文生图提供商、工具 API 密钥和学术检索密钥。",
    modelsTitle: "模型配置",
    modelsDescription:
      "添加和管理聊天模型提供商。每个模型需要提供商、模型名称和 API 密钥。",
    toolKeysTitle: "工具 / 学术 API 密钥",
    toolKeysDescription:
      "配置网络搜索、网页抓取和学术检索增强所需的密钥。",
    imageGenerationTitle: "文生图配置",
    imageGenerationDescription:
      "选择当前生效的文生图提供商，并配置 Google AI Studio 或 OpenAI 兼容接口。",
