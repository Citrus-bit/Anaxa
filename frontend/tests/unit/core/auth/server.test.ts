...
describe("getServerSideUser", () => {
  ...
  beforeEach(() => {
    ...
    setEnv("MEDRIX_FLOW_ENV", undefined);
  ...
  test("does not enable auth-disabled mode with the documented MEDRIX production marker", async () => {
    setEnv("DEER_FLOW_AUTH_DISABLED", "1");
    setEnv("MEDRIX_FLOW_ENV", "production");
